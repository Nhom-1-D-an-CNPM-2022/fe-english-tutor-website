const PROJECT_ID = 'SKznnOxRm74euIFLDCrSFBx98RxZOGEzgw';
const PROJECT_SECRET = 'OXZpeE1aVGNMMEwyWWcwbHRiQXB4RzBHQXNWc0c0Zg==';
...
export const apiVideoCall = new API(PROJECT_ID, PROJECT_SECRET);
